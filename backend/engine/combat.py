from .constants import BASE_SPELL_SAVE_DC


def calculate_attack_bonus(
    ability_mod: int, is_proficient: bool, prof_bonus: int, misc_bonuses: int = 0
) -> int:
...
def calculate_save_dc(ability_mod: int, prof_bonus: int, misc_bonuses: int = 0) -> int:
    ...
    return BASE_SPELL_SAVE_DC + ability_mod + prof_bonus + misc_bonuses
